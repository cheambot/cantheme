...
<head>
	...
	<?php wp_head(); ?>
	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="http://staffintranet/wp-content/css/bootstrap.css?v=1.8" type="text/css">
	<link href="http://staffintranet/wp-content/css/fontawesome-all.css" rel="stylesheet" type="text/css">
	<link href="http://staffintranet/wp-content/css/tether.css" rel="stylesheet" type="text/css">
	<!-- Slick CSS -->
	<link rel="stylesheet" type="text/css" href="http://staffintranet/wp-content/css/slick.css"/>
	<link rel="stylesheet" type="text/css" href="http://staffintranet/wp-content/css/slick-theme.css"/>
	<link rel="stylesheet" type="text/css" href="http://staffintranet/wp-content/themes/cantheme/style.css?v=2.0.2.2"/>
	<link href="http://staffintranet/wp-content/themes/cantheme/cctv-css/ekko-lightbox.css" rel="stylesheet" type="text/css">
</head>
<body <?php body_class(); ?>>
	<div class="bg-dark mb-3">
		<div class="maxwide m-auto p-0">
			<nav class="navbar navbar-toggleable-sm navbar-light p-0 pl-2">
				...
				<img class="float-right" src="http://staffintranet/wp-content/images/small-logo.png" alt="CHS Logo">
			</nav>
		</div>
	</div>
...
$dir = new RecursiveDirectoryIterator( './wp-content/themes/cantheme/cctv/thumbs', FilesystemIterator::SKIP_DOTS );
...
foreach ( $it as $fileinfo ) {
	...
	elseif ( $fileinfo->isFile() ) {
		...
		if (in_array(strtolower($filetype), $filetypes)) {
			...
			echo "<a href=\"/wp-content/themes/cantheme/cctv/" . $dir . "/" . $file . ".jpg\"  data-toggle=\"lightbox\" data-title=\"".$file."\"  data-gallery=\"".$dir."\"><img class=\"img-fluid pb-1\" src=\"/wp-content/themes/cantheme/cctv/thumbs/" . $dir . "/" . $file . ".jpg\"><br>" . $file . "</a>\n";
			echo "</div>\n";
		}
	}
}
