...
$dir = new RecursiveDirectoryIterator( './wp-content/themes/cheamtheme/internal-cctv/thumbs', FilesystemIterator::SKIP_DOTS );
...
foreach ( $it as $fileinfo ) {
	...
	elseif ( $fileinfo->isFile() ) {
		...
		if (in_array(strtolower($filetype), $filetypes)) {
			...
			echo "<a href=\"/wp-content/themes/cheamtheme/internal-cctv/" . $dir . "/" . $file . ".jpg\"  data-toggle=\"lightbox\" data-title=\"".$file."\"  data-gallery=\"".$dir."\"><img class=\"img-fluid pb-1\" src=\"/wp-content/themes/cheamtheme/internal-cctv/thumbs/" . $dir . "/" . $file . ".jpg\"><br>" . $file . "</a>\n";
			echo "</div>\n";
		}
	}
}
